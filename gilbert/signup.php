...
<body>
      ...
      <div class="container-fluid">
        <div class="collapse navbar-collapse d-lg-flex" id="navbarsExample11">
         <p class="navbar-brand col-lg-3 me-0 text-primary">user signup</p>
    ...
    <div class="bg-light" style="height: 500px;position: relative;top: -15px;">
    	<form action="signup_check.php" method="POST" class="fullpageLoyout container-fluid">
			...
			<button class="btn btn-primary" type="submit" name="submit" id="login">signup here</button>
			<hr>
			<div>
				<p>if you have an account click<a href="login.php">  login</a></p>
			</div>
	</div>
		</form>
    </div>
